    ...
    <main className="min-h-screen bg-white dark:bg-[#0B1121] transition-colors duration-300">
      ...
      <section id="projects" className="py-12 sm:py-16 md:py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <ScrollAnimation>
            <div className="relative mb-12 sm:mb-16 md:mb-40">
              {/* Titre en arrière-plan */}
              <div className="absolute -top-4 sm:-top-8 md:-top-16 left-0 w-full overflow-hidden">
                <h2 className="text-3xl sm:text-6xl md:text-8xl lg:text-[12rem] font-bold text-gray-200/40 dark:text-gray-600/40 break-words whitespace-pre-line">
                  {translations.home.projects.title}
                </h2>
              </div>

              {/* Bouton Voir tous les projets */}
              <div className="flex justify-end relative z-10 mt-8 sm:mt-0">
                <Link 
                  href="/projects"
                  className="bg-gray-900 dark:bg-white text-white dark:text-black px-3 sm:px-6 py-2 sm:py-3 rounded-lg flex items-center gap-2 hover:bg-gray-800 dark:hover:bg-gray-100 transition-colors text-sm sm:text-base"
                >
                  <span>{translations.home.projects.viewAll}</span>
