  ...
  return (
    <div className="w-full h-full bg-white dark:bg-gray-900 flex flex-col items-center justify-center p-8 relative overflow-hidden">
      ...
      <div className="text-center mb-8">
        <h3 className="text-sm font-black tracking-widest text-gray-400 uppercase">{ticket.scanForDemo}</h3>
      </div>

      <div className="bg-white p-4 rounded-2xl shadow-xl border border-gray-100 mb-8">
        <QRCode 
          value="https://phil-dev-ghostessos-projects.vercel.app/"
          size={160}
          fgColor="#0B1121"
          level="H"
        />
      ...
      <div className="text-center space-y-2">
        <p className="text-[10px] font-bold text-primary-developer uppercase tracking-[0.25em]">{ticket.accessKey}</p>
